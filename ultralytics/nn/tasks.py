...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    #         pass
        ...
        if m in ((
            Classify,Conv,ALDS,ConvTranspose,GhostConv,Bottleneck,GhostBottleneck,SPP,SPPF,GSPPF,C2fPSA,C2PSA,DWConv,Focus,BottleneckCSP,C1,C2,C2f,
            C3k2,DEFF,RepNCSPELAN4,ELAN1,ADown,AConv,SPPELAN,C2fAttn,C3,C3TR,C3Ghost,nn.ConvTranspose2d,DWConvTranspose2d,C3x,RepC3,PSA,SCDown,
            C2fCIB,
        ) ):
            c1, c2 = ch[f], args[0]
            ...
            if m in (
                ...
                n = 1
            if m is (C3k2,DEFF) and scale in "mlx":  # for M/L/X sizes
                args[3] = True
        elif m is AIFI:
            args = [ch[f], *args]
